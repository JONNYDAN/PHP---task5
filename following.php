...
INNER JOIN users u ON u.id_user = f.id_follower
WHERE f.id_follower = ?";
                ...
                <div class="game-blocks row no-gutters" id="relatedGames">
                    ...
                    ?>
                        <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                            <a href="user-profile/<?php echo $row['id_following'] ?>" title="">
                                <div class="game-block">
                                    <div class="box" id="box_<?php echo $row['id_following'] ?>">
                                        <?php
                                        $query_info = "SELECT * FROM  users u 
                                        WHERE id_user = ?";
                                        $statement_info = $pdo->prepare($query_info);
                                        $statement_info->execute([$row['id_following']]);
