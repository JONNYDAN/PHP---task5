...
<head>
        ...
        <meta name="csrf-token" content="kykz4nkc4wJ5ZuV25OkqXVpcC4RUmwMNNQhN2tlc">
        <title>Dashboard | ALL 2048</title>
        <meta name="robots" content="noindex, nofollow">
        <meta name="description" content="Dashboard">
        <meta property="og:title" content="Dashboard">
        <meta property="og:description" content="Dashboard">
        <meta property="og:url" content="https://all2048.com/dashboard">
        <meta property="og:type" content="article">
        <meta property="og:image" content="https://all2048.com/assets/img/2048.jpg">
        <link rel="canonical" href="https://all2048.com/dashboard">
        <link rel='shortcut icon' type='image/x-icon' href="https://all2048.com/assets/img/favicon.ico">
        <style>
        ...
        <link rel="stylesheet" href="https://all2048.com/assets/css/app.css?v=56">
        <link rel="stylesheet" href="https://all2048.com/assets/css/user/user.css?v=56">
        <link rel="stylesheet" href="https://all2048.com/assets/css/user/dashboard.css?v=56">
        <style>
            @font-face {
                ...
                <div class="container-fluid">
                    <div class="verification-warning">
                        <div class="alert alert-secondary" role="alert">
                            Your email is not yet verified. Please <a href="https://all2048.com/email/verify">verify your email address</a>
                            as we will prioritize users who have already verified their email addresses (when publishing games). 
                        </div>
                    </div>
                    <div class="user-details">
                        <form id="avatarForm" action="https://all2048.com/dashboard" method="post" enctype="multipart/form-data" class="">
                        ...
                        <h1 class="title user-name">jack</h1>
                        <a class="bordered-button mt-10" href="https://all2048.com/user/jack04122k4">View Profile</a>
                        <div class="profile-options">
                            ...
                            <ul id="profileOptionsList">
                                <li>
                                    <a href="https://all2048.com/reset-password">Reset Password</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                </li>
                            </ul>
                            <form id="logout-form" action="https://all2048.com/logout" method="POST" style="display: none;">
                                <input type="hidden" name="_token" value="kykz4nkc4wJ5ZuV25OkqXVpcC4RUmwMNNQhN2tlc">
                            </form>
                        </div>
                    </div>
                    <div class="user-menu">
                        <a href="https://all2048.com/favorite-games">Favorites</a>
                        <a href="https://all2048.com/followed-user-games">FU Games</a>
                        <a href="https://all2048.com/followers">Followers</a>
                        <a href="https://all2048.com/following">Following</a>
                        <a href="https://all2048.com/create-a-game">Create</a>
                        <a href="https://all2048.com/logout">Logout</a>
                    </div>
                    <div class="profile-games profile-no-type-games">
                        <h2>
                            <a href="javascript:void(0);">
                                Games <span class="games-count">0</span>
                            </a>
                        </h2>
                        <div class="row no-gutters">
                            <div class="col-12">
                                <div class="dont-have-any-item text-center">
                                    ...
                                    <a href="https://all2048.com/create-a-game" class="btn btn-primary">Create a new game</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="privacy-explanation">
                        ...
                        <p class="public">
                            ...
                            : These games will be publicly visible on your <a href="https://all2048.com/user/jack04122k4">profile</a>
