...
<head>
        ...
        <title>jack | ALL 2048</title>
        <meta name="robots" content="noindex">
        <link rel="canonical" href="https://all2048.com/user/jack04122k4">
...
<div class="content-wrapper" id="contentWrapper" onclick="hideLivesearch()">
            <div class="content page-profile" id="content">
                <div class="container-fluid mb-50">
                    <div class="user-details has-badge junior-user">
                        <div class="user-avatar-wrapper">
                            <div class="user-avatar">
                                <div class="box" id="box_0"></div>
                                <span class="badge-name">Junior</span>
                            </div>
                    ...
                    <div class="row no-gutters mt-15">
                        <div class="url-group">
                            <h2>Best Scores</h2>
                            <a href="https://all2048.com/user/jack04122k4/latest-scores">Latest Scores</a>
                            <a href="https://all2048.com/user/jack04122k4/games">My Games (0)</a>
                            <a href="https://all2048.com/dashboard">Dashboard</a>
                        </div>
                    </div>
                    <div class="empty-games-wrapper">
                        <div class="empty-games">
                            <p>No scores found</p>
                        </div>
                    </div>
                    <div class="url-group special-links mt-50">
