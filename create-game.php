        ...
        <div class="content" id="content" style="min-height: calc(100vh - 127px);">
            <div class="container-fluid">
                <article class="article">
                    <h1 class="title">How to create a 2048 game</h1>
                    <p>We've introduced a user login system to make it easier for you to create and play your games right away. So, you'll just need to log in to create your games.</p>
                    <p class="highlighted-info">Please <a href="login">Log in</a> or <a href="register">Register</a> to create your games.</p>
                    <p>You can get a lot of benefits by logging in. We've already added some new features for our registered users. You can now add any game to your Favorites list, follow other users and see their games on your dashboard.</p>
                    <p>If you create a private game, it will not require any approval from us. But if you want to publish your game on our public pages, it will need an approval like before.</p> <br>
                </article>
            </div>
        </div>
    </div>
...
?>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create'])) {
        ...
        if ($valid == 1) {
            ...
            $file_data_thumb = getFileName('thumbnail_game', 0);
            $file_data_1 = getFileName('img_1_game', 1);
            $file_data_2 = getFileName('img_2_game', 2);
            $file_data_3 = getFileName('img_3_game', 3);
            $file_data_4 = getFileName('img_4_game', 4);
            $file_data_5 = getFileName('img_5_game', 5);
            $file_data_6 = getFileName('img_6_game', 6);
            $file_data_7 = getFileName('img_7_game', 7);
            $file_data_8 = getFileName('img_8_game', 8);
            $file_data_9 = getFileName('img_9_game', 9);
            $file_data_10 = getFileName('img_10_game', 10);
            $file_data_11 = getFileName('img_11_game', 11);
            $file_data_12 = getFileName('img_12_game', 12);
            $file_data_13 = getFileName('img_13_game', 13);
            $file_data_14 = getFileName('img_14_game', 14);
            $file_data_15 = getFileName('img_15_game', 15);
            $file_data_16 = getFileName('img_16_game', 16);
