...
if (isset($_GET['id'])) {
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    <div class="content-wrapper" id="contentWrapper">
      <div class="content game-single" id="content">
        ...
        <div class="game-content noselect" id="gameContent">
          <img class="fs-close-btn" id="fullscreenEndTrigger" src="https://all2048.com/img/cross.svg" alt="Close">
          <div class="game-container-wrapper game-type-custom">
            ...
            if (isset($_GET['size'])) {
              ...
              switch ($size) {
                case '5':
                  echo '<div class="game-container gs-5"> <div class="game-message"> <p></p> <div class="lower"> <a class="keep-playing-button" role="button" style="display:none">Keep going</a> <div class="score-sharing">&nbsp;</div> <a class="retry-button" role="button">Play again</a> </div> </div> <div class="grid-container"> <div class="grid-row"> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> </div> <div class="grid-row"> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> </div> <div class="grid-row"> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> </div> <div class="grid-row"> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> </div> <div class="grid-row"> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> <div class="grid-cell"></div> </div> </div> <div class="tile-container"><div class="tile tile-2 tile-position-4-2 tile-new"><div class="tile-inner"><span class="tile-text">2</span></div></div><div class="tile tile-2 tile-position-5-1 tile-new"><div class="tile-inner"><span class="tile-text">2</span></div></div></div> </div>';
                  break;
                case '6':
                ...
                <div class="settings-modal-content-inner">
                  ...
                  <div class="settings-modal-body">
                    ...
                    <div class="settings-item settings-bg-1">
                      ...
                      <div class="settings-item-right settings-off">
                        <p>
                          <a href="javascript:void(0);" role="button" id="resetBtnTrigger">Reset</a>
                        </p>
                      </div>
                    </div>
                    <div class="settings-item settings-bg-2">
        ...
        <div class="gf-buttons">
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="game.php?id=<?php echo $row['id_game'] ?>&size=4">4 x 4</a>
                </li>
                <li>
                  <a href="game.php?id=<?php echo $row['id_game'] ?>&size=5">5 x 5</a>
                </li>
                <li>
                  <a href="game.php?id=<?php echo $row['id_game'] ?>&size=6">6 x 6</a>
                </li>
              </ul>
            </li>
            <li>
              <a id="scoresBtn" href="javascript:void(0);" role="button">
        ...
        <div class="game-scores-container mt-30" id="gameScoresContainer">
          <div class="game-scores" id="gameScores">&nbsp;</div>
        </div>
        <div class="social-share">
          ...
          <ul>
            <li class="twitter-old">
              <a rel="nofollow" class="locale-data-title" href="#" target="_blank" title="Share on Twitter">
            ...
            <li class="facebook">
              <a rel="nofollow" class="locale-data-title" href="#" target="_blank" title="Share on Facebook">
        ...
        <div class="game-scores-container mt-30 show" id="gameScoresContainer">
          <div class="game-scores" id="gameScores">
            <div class="container-fluid">
            <div class="loading-scores"><img src="https://all2048.com/img/loading/loader-search.svg" alt="Loading..." width="35" height="35"></div>
             <?php 
              if (!isset($_SESSION['user'])) {
                echo '<p class="log-in-warning">(Please <a href="login.php">Log in</a> or <a href="register.php">Register</a> to save your scores)</p>';
              }
             ?>
            <div class="scores top" id="scores">
                <div class="score-header noselect">
                  <h2 class="title-top-score" onclick="toggleScores('top');">Top Scores</h2>
                </div>
                <div class="score-content">
                  ...
                  <div class="content-latest-score">
                    <div class="table-responsive">
                      <table class="table table-bordered" id="scoreTableLatest">
                        <thead>
                          <tr>
                            <th scope="col">#</th>
                            <th scope="col">Name</th>
                        ...
                        <tbody id="scoreTableBodyLatest">
                          <tr>
                            <th scope="row">1</th>
                            <td><a href="https://all2048.com/user/dear_h">Stella</a></td>
                            <td>256</td>
                            <td>3548</td>
                          </tr>
                          <tr>
                            <th scope="row">2</th>
                            <td><a href="https://all2048.com/user/yeosanghwa">aurora</a></td>
                            <td>256</td>
                            <td>3180</td>
                          </tr>
                          <tr>
                            <th scope="row">3</th>
                            <td><a href="https://all2048.com/user/adakacang">Ada</a></td>
                            <td>256</td>
                            <td>3072</td>
                          </tr>
                        </tbody>
          ...
          <div class="row text-center">
            <div class="col">
              <div class="load-more">
                ...
                <img src="https://all2048.com/img/search/search.svg" alt="Loading" width="35">
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- <script>
      ...
      // Ví dụ về cách gọi updateMoveCount khi có di chuyển
      document.addEventListener('keydown', function (event) {
        if (event.key === 'ArrowUp' || event.key === 'w' || event.key === 'ArrowDown' || event.key === 's' || event.key === 'ArrowLeft' || event.key === 'a' || event.key === 'ArrowRight' || event.key === 'd') {
          updateMoveCount();
        }
      });
